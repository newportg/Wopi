    ...
    public static class DocumentDBRepository<T>
    {
        ...
        private static String DatabaseId
        {
            get
            {
                if (string.IsNullOrEmpty(databaseId))
                {
                    databaseId = System.Environment.GetEnvironmentVariable("ddb:database");
                }
        ...
        private static DocumentClient Client
        {
            get
            {
                if (client == null)
                {
                    string endpoint = System.Environment.GetEnvironmentVariable("ddb:endpoint");
                    string authKey = System.Environment.GetEnvironmentVariable("ddb:authKey");
                    Uri endpointUri = new Uri(endpoint);
                    client = new DocumentClient(endpointUri, authKey);
                }
